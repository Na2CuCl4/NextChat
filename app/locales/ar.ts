...
const ar: PartialLocaleType = {
  WIP: "قريبًا...",
  Error: {
    Unauthorized: `😆 واجهت المحادثة بعض المشكلات، لا داعي للقلق: إذا كنت تستخدم إصدار النشر الخاص، انقر [هنا](/#/auth) لإدخال مفتاح الوصول 🔑`,
  },
  Auth: {
  ...
  FileConversion: {
    ...
    MinerU: {
      ParseBackend: {
        ...
        HybridEngineDesc: "تحليل هجين عالي الدقة، يدعم لغات متعددة.",
      },
      MaxPages: {
      ...
      OcrLanguage: {
        Title: "لغة OCR",
        Ch: "الصينية، الإنجليزية، اليابانية، الصينية التقليدية، اللاتينية",
        ChServer:
          "الصينية، الإنجليزية، اليابانية، الصينية التقليدية، اللاتينية",
      ...
      Effort: {
        ...
        Medium: "medium",
        MediumDesc:
          "تحليل أسرع، يوازن بين الدقة والكفاءة. تحليل الصور/الرسوم البيانية معطل.",
        High: "high",
        HighDesc:
          "تحليل عالي الدقة مع دعم تحليل الصور/الرسوم البيانية، قد يستغرق وقتًا أطول.",
      },
    },
    FileList: {
      Upload: "رفع ملف",
      ...
      DownloadAll: "حزم وتحميل الكل",
      Packaging: "جاري الحزم",

...
const tw: PartialLocaleType = {
  ...
  FileConversion: {
    Title: "檔案轉換",
    SubTitle:
      "將二進位檔案（如 DOCX / PPTX / XLSX / PDF）轉換為文字檔案（如 Markdown），便於 AI 識別與理解。",
    Settings: "設定",
    Conversion: "轉換",
    Engine: {
      Title: "檔案轉換引擎",
      MarkItDown: "MarkItDown",
      MarkItDownDesc: "使用 MarkItDown 進行文件轉換。",
      MinerU: "MinerU",
      MinerUDesc:
        "使用 MinerU 進行文件轉換，專為 LLM · RAG · Agent 場景構建的高精度文件解析引擎。",
    },
    HealthCheck: {
      Title: "檢查可用性",
      Action: "檢查",
    ...
    MarkItDown: {
      EnableDocIntelligence: {
        Title: "使用文件智慧",
        Desc: "基於 AI 進行文件轉換，提升複雜文件的轉換品質，會顯著增加轉換時間。",
      },
    },
    MinerU: {
      ParseBackend: {
        Title: "解析後端",
        Pipeline: "pipeline",
        PipelineDesc: "傳統多模型管線解析，支援多語言，無幻覺。",
        VlmEngine: "vlm-engine",
        VlmEngineDesc: "多模態大模型高精度解析，僅支援中英文文件。",
        HybridEngine: "hybrid-engine",
        HybridEngineDesc: "高精度混合解析，支援多語言。",
      },
      MaxPages: {
        Title: "最大轉換頁數",
      },
      ...
      EnableInlineFormulaRecognition: {
        Title: "啟用行內公式辨識",
        Desc: "停用後，行內公式將不會被偵測或解析。",
      },
      EnableImageAnalysis: {
        Title: "啟用圖片分析",
        Desc: "停用後，圖片/圖表區塊仍保留版面位置，但跳過 VLM 圖片/圖表分析。",
      },
      ParseMethod: {
        Title: "解析方式",
        Auto: "基於檔案類型自動決定。",
        Txt: "使用文字擷取方法。",
        Ocr: "對圖片 PDF 使用 OCR 方法。",
      },
      OcrLanguage: {
        Title: "OCR 語言",
        Ch: "中文、英文、日文、繁體中文、拉丁文",
        ChServer: "中文、英文、日文、繁體中文、拉丁文",
        Korean: "韓文、英文",
        Ta: "坦米爾文、英文",
        Te: "泰盧固文、英文",
        Ka: "康納達文",
        Th: "泰文、英文",
        El: "希臘文、英文",
        Arabic: "阿拉伯語、波斯語、烏爾都語等",
        EastSlavic: "俄語、白俄羅斯語、烏克蘭語、英文",
        Cyrillic: "俄語、西里爾語系語言",
        Devanagari: "印地語、馬拉提語、尼泊爾語等",
      },
      Effort: {
        Title: "解析精度",
        Medium: "medium",
        MediumDesc: "快速解析，平衡精度與效率，不分析圖片/圖表。",
        High: "high",
        HighDesc: "高精度解析，支援圖片/圖表分析，耗時更長。",
      },
    },
    FileList: {
      Upload: "上傳檔案",
      ...
      Delete: "刪除",
      AccessCodeError: "存取密碼不正確！",
      DragDropHint: "將檔案拖放到此處上傳",
      ActionsLabel: "操作",
      DownloadAll: "打包下載全部",
      Packaging: "打包中",
      ErrorInfo: "錯誤資訊",
      UnknownError: "未知錯誤",
      LogPlaceholder: "轉換資訊顯示在這裡",
    },
  },
};

...
const bn: PartialLocaleType = {
  ...
  FileConversion: {
    ...
    MinerU: {
      ...
      OcrLanguage: {
        Title: "OCR ভাষা",
        Ch: "চীনা, ইংরেজি, ঐতিহ্যবাহী চীনা",
        ChLite: "চীনা, ইংরেজি, ঐতিহ্যবাহী চীনা, জাপানি",
        ChServer: "চীনা, ইংরেজি, ঐতিহ্যবাহী চীনা, জাপানি",
        En: "ইংরেজি",
        Korean: "কোরিয়ান, ইংরেজি",
        Japan: "জাপানি, চীনা, ইংরেজি, ঐতিহ্যবাহী চীনা",
        ChineseCht: "ঐতিহ্যবাহী চীনা, চীনা, ইংরেজি, জাপানি",
        Ta: "তামিল, ইংরেজি",
        Te: "তেলুগু, ইংরেজি",
        Ka: "কন্নড়",
        Th: "থাই, ইংরেজি",
        El: "গ্রিক, ইংরেজি",
        Latin: "ফরাসি, জার্মান, ইত্যাদি (ল্যাটিন লিপির ভাষা)",

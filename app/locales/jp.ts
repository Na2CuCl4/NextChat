  ...
  FileConversion: {
    ...
    MinerU: {
      ParseBackend: {
        ...
        VlmEngineDesc: "マルチモーダル VLM 高精度解析、中国語と英語のみ対応。",
        HybridEngine: "hybrid-engine",
        HybridEngineDesc: "高精度ハイブリッド解析、多言語対応。",
      },
      MaxPages: {
        Title: "最大変換ページ数",
      },
      ...
      OcrLanguage: {
        Title: "OCR 言語",
        Ch: "中国語、英語、日本語、繁体中国語、ラテン語",
        ChServer: "中国語、英語、日本語、繁体中国語、ラテン語",
        Korean: "韓国語、英語",
        Ta: "タミル語、英語",
        Te: "テルグ語、英語",
        Ka: "カンナダ語",
      ...
      Effort: {
        Title: "解析精度",
        Medium: "medium",
        MediumDesc: "高速解析、精度と効率のバランス。画像/チャート分析は無効。",
        High: "high",
        HighDesc:
          "高精度解析、画像/チャート分析をサポート。処理時間が長くなる場合があります。",
      },
    },
    FileList: {
      Upload: "ファイルをアップロード",

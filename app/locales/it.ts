...
const it: PartialLocaleType = {
  ...
  Error: {
    Unauthorized: `😆 La conversazione ha incontrato alcuni problemi, non preoccuparti: Se stai utilizzando una versione di distribuzione privata, clicca [qui](/#/auth) per inserire la chiave di accesso 🔑`,
  },
  Auth: {
  ...
  FileConversion: {
    ...
    FileList: {
      ...
      ActionsLabel: "Azioni",
      DownloadAll: "Pacchetto e scarica",

  ...
  FileConversion: {
    ...
    MinerU: {
      ParseBackend: {
        ...
        VlmEngineDesc: "多模态大模型高精度解析，仅支持中英文文档。",
        HybridEngine: "hybrid-engine",
        HybridEngineDesc: "高精度混合解析，支持多语言。",
      },
      MaxPages: {
        Title: "最大转换页数",
      },
      ...
      Effort: {
        Title: "解析精度",
        Medium: "medium",
        MediumDesc: "快速解析，平衡精度与效率，不分析图片/图表。",
        High: "high",
        HighDesc: "高精度解析，支持图片/图表分析，耗时更长。",
      },
    },
    FileList: {
      Upload: "上传文件",

...
const ru: PartialLocaleType = {
  ...
  FileConversion: {
    ...
    MinerU: {
      ...
      OcrLanguage: {
        Title: "Язык OCR",
        Ch: "Китайский, английский, японский, традиционный китайский, латиница",
        ChServer:
          "Китайский, английский, японский, традиционный китайский, латиница",
      ...
      Effort: {
        ...
        Medium: "medium",
        MediumDesc:
          "Более быстрый анализ, баланс точности и эффективности. Анализ изображений/графиков отключен.",
        High: "high",
        HighDesc:
          "Анализ с повышенной точностью и поддержкой анализа изображений/графиков, может занять больше времени.",
      },
    },
    FileList: {

...
const ru: PartialLocaleType = {
  ...
  FileConversion: {
    ...
    SubTitle:
      "Преобразуйте бинарные файлы (например, DOCX / PPTX / XLSX / PDF) в текстовые файлы (например, Markdown) для распознавания и понимания ИИ.",
    Settings: "Настройки",
    Conversion: "Конвертация",
    Engine: {
      Title: "Движок конвертации файлов",
      MarkItDown: "MarkItDown",
      MarkItDownDesc: "Конвертация документов с помощью MarkItDown.",
      MinerU: "MinerU",
      MinerUDesc:
        "Конвертация документов с помощью MinerU, высокоточного движка парсинга документов, созданного для сценариев LLM · RAG · Agent.",
    },
    HealthCheck: {
    ...
    MarkItDown: {
      EnableDocIntelligence: {
        Title: "Использовать Document Intelligence",
        Desc: "Конвертация документов на основе ИИ, улучшает качество сложных документов, значительно увеличивает время конвертации.",
      },
    },
    MinerU: {
      ParseBackend: {
        Title: "Бэкенд парсинга",
        Pipeline: "pipeline",
        PipelineDesc:
          "Традиционный многомодельный пайплайн, поддерживает несколько языков, без галлюцинаций.",
        VlmAutoEngine: "vlm-auto-engine",
        VlmAutoEngineDesc:
          "Мультимодальный VLM высокоточный парсинг, поддерживает только китайский и английский.",
        HybridAutoEngine: "hybrid-auto-engine",
        HybridAutoEngineDesc:
          "Высокоточный гибридный парсинг, поддерживает несколько языков.",
      },
      MaxPages: {
        Title: "Макс. страниц конвертации",
      },
      EnableTableRecognition: {
        Title: "Включить распознавание таблиц",
        Desc: "При отключении таблицы будут отображаться как изображения.",
      },
      EnableInlineFormulaRecognition: {
        Title: "Включить распознавание встроенных формул",
        Desc: "При отключении встроенные формулы не будут обнаружены или обработаны.",
      },
      EnableImageAnalysis: {
        Title: "Включить анализ изображений",
        Desc: "При отключении блоки изображений/графиков сохраняют позицию, но анализ VLM пропускается.",
      },
      ParseMethod: {
        Title: "Метод парсинга",
        Auto: "Определяется автоматически на основе типа файла.",
        Txt: "Использовать метод извлечения текста.",
        Ocr: "Использовать метод OCR для PDF на основе изображений.",
      },
      OcrLanguage: {
        Title: "Язык OCR",
        Ch: "Китайский, английский, традиционный китайский",
        ChLite: "Китайский, английский, традиционный китайский, японский",
        ChServer: "Китайский, английский, традиционный китайский, японский",
        En: "Английский",
        Korean: "Корейский, английский",
        Japan: "Японский, китайский, английский, традиционный китайский",
        ChineseCht: "Традиционный китайский, китайский, английский, японский",
        Ta: "Тамильский, английский",
        Te: "Телугу, английский",
        Ka: "Каннада",
        Th: "Тайский, английский",
        El: "Греческий, английский",
        Latin: "Французский, немецкий и др. (языки с латиницей)",
        Arabic: "Арабский, персидский, урду и др.",
        EastSlavic: "Русский, белорусский, украинский, английский",
        Cyrillic: "Русский, кириллические языки",
        Devanagari: "Хинди, маратхи, непальский и др.",
      },
    },
    FileList: {
      ...
      Delete: "Удалить",
      AccessCodeError: "Код доступа неверен!",
      DragDropHint: "Перетащите файлы сюда для загрузки",
      ActionsLabel: "Действия",
      DownloadAll: "Упаковать и скачать всё",
      Packaging: "Упаковка",
      ErrorInfo: "Информация об ошибке",
      UnknownError: "Неизвестная ошибка",
      LogPlaceholder: "Журнал конвертации появится здесь",
    },
  },
};

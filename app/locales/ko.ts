  ...
  FileConversion: {
    ...
    MinerU: {
      ParseBackend: {
        ...
        VlmAutoEngineDesc: "멀티모달 VLM 고정밀 파싱, 중국어와 영어만 지원.",
        HybridAutoEngine: "hybrid-auto-engine",
        HybridAutoEngineDesc: "고정밀 하이브리드 파싱, 다국어 지원.",
      },
      MaxPages: {
        Title: "최대 변환 페이지",
      },
      ...
      OcrLanguage: {
        Title: "OCR 언어",
        Ch: "중국어, 영어, 번체 중국어",
        ChLite: "중국어, 영어, 번체 중국어, 일본어",
        ChServer: "중국어, 영어, 번체 중국어, 일본어",
        En: "영어",
        Korean: "한국어, 영어",
        Japan: "일본어, 중국어, 영어, 번체 중국어",
        ChineseCht: "번체 중국어, 중국어, 영어, 일본어",
        Ta: "타밀어, 영어",
        Te: "텔루구어, 영어",
        Ka: "칸나다어",
        Th: "태국어, 영어",
        El: "그리스어, 영어",
        Latin: "프랑스어, 독일어 등 (라틴 문자 언어)",
